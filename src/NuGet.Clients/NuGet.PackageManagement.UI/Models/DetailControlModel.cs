...
namespace NuGet.PackageManagement.UI
{
    ...
    public abstract class DetailControlModel : INotifyPropertyChanged, IDisposable
    {
        ...
        private async ValueTask SelectedVersionChangedAsync(PackageItemViewModel packageItemViewModel, DisplayVersion displayVersion, CancellationToken cancellationToken)
        {
            ...
            var bestVersionForRange = displayVersion.Range.FindBestMatch(_allPackageVersions.Select(version => version.version));
            ...
            if (packageSearchMetadata != null &&
                (packageSearchMetadata.Identity.Version.Equals(displayVersion.Version) ||
