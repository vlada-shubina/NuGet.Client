...
namespace NuGet.VisualStudio.Internal.Contracts
{
    public static class NuGetServices
    {
        ...
        private const string RestoreServiceName = "Microsoft.VisualStudio.NuGet.RestoreService";
        private const string RestoreServiceVersion = "1.0";
        ...
        public static readonly ServiceRpcDescriptor RestoreService = new NuGetServiceMessagePackRpcDescriptor(
            new ServiceMoniker(RestoreServiceName, new Version(RestoreServiceVersion)));
    }
}
