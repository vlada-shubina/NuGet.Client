...
namespace NuGet.Commands {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Certificate file &apos;{0}&apos; is not supported on this platform. For a list of accepted ways to provide a certificate, visit https://docs.nuget.org/docs/reference/command-line-reference.
        /// </summary>
        internal static string SignCommandUnsupportedCertException
        {
            get
            {
                return ResourceManager.GetString("SignCommandUnsupportedCertException", resourceCulture);
            }
        }
