...
namespace NuGet.PackageManagement.VisualStudio.Test
{
    ...
    public class CpsPackageReferenceProjectTests
    {
        ...
        RestoreCommand command1;
        RestoreCommand command2;
        ...
        public async Task GlobalSetup()
        {
            ...
            var projectA = CreateCpsPackageReferenceProject(projectName, projectFullPath, projectCache);
            var projectIntermed = CreateCpsPackageReferenceProject("projectIntermed", projectFullPath, projectCache);
            var projectMain = CreateCpsPackageReferenceProject("projectMain", projectFullPath, projectCache);
            ...
            projectCache.AddProject(projectNames, projectAdapter, projectA).Should().BeTrue();
            ...
            await SimpleTestPackageUtility.CreateFullPackageAsync(packageSource.FullName, "packageA", Version);

            // Act
            command1 = new RestoreCommand(request);
            command2 = new RestoreCommand(request);
        }
        ...
        ////[Benchmark(Description = "Test0:NewImplementation")]
        //[Fact]
        //public async Task GetInstalledVersion_WithAssetsFile_ReturnsVersionsFromAssetsSpecs2()
        //{
