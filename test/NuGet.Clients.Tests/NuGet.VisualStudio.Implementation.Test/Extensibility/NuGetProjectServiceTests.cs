...
namespace NuGet.VisualStudio.Implementation.Test.Extensibility
{
    public class NuGetProjectServiceTests
    {
        ...
        class TestPackageReferenceProject : PackageReferenceProject<List<PackageReference>, PackageReference>
        {
            ...
            protected override IReadOnlyList<PackageReference> ResolvedInstalledPackagesList(IEnumerable<LibraryDependency> libraries, NuGetFramework targetFramework, IReadOnlyList<LockFileTarget> targets, List<PackageReference> installedPackages)
            {
                throw new NotImplementedException();
            }
